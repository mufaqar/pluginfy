...
//                                                             </Link>
//                                                         </li>
//                                                         <li><i className="fal fa-calendar" />{blogPost.date}</li>
//                                                     </ul>
//                                                 </div>
//                                             </div>
...
//                                                                 <span><i className="fal fa-calendar-alt" />{blogPost.date}</span>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-10">
              <div className="blog-details-wrap">
                ...
                <div className="bd-content-top text-center">
                  <div className="blog-meta-two">
                    <ul className="list-wrap">
                      ...
                      <li><i className="fal fa-clock" />{blogPost.readingTime}</li>
                    </ul>
                  </div>
                  <h2 className="title">{blogPost.title}</h2>
                  <p>{blogPost.contentTop}</p>
                  <div className="blog-meta-two bottom">
                    <ul className="list-wrap">
                      <li className="avatar">
                        <img src="/assets/img/blog/blog_avatar01.png" alt={blogPost.author} /> {blogPost.author}
                      </li>
                      <li><i className="fal fa-calendar" />{blogPost.date}</li>
                    </ul>
                  </div>
                ...
                {/* Main Image */}
                <div className="blog-details-img">
                  <img src={`/assets/img/blog/${blogPost.img}`} alt={blogPost.title} className="w-100" />
                </div>
                ...
                {/* Comments */}
                <div className="comment-wrap">
                  <h2 className="title">{blogPost.comments.length} <span>Comments</span></h2>
                  <div className="latest-comments">
                    <ul className="list-wrap">
                      {blogPost.comments.map((c, i) => (
                        <li key={i}>
                          <div className="comments-box">
                            <div className="comments-avatar">
                              <img src={`/assets/img/blog/comment_avatar0${i + 1}.png`} alt={c.name} />
                            </div>
                            <div className="comment-text">
                              <h4 className="title">{c.name}</h4>
                              <span><i className="fal fa-calendar-alt" />{c.date}</span>
                              <p>{c.text}</p>
                            </div>
                          </div>
                        </li>
