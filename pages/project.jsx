...
export default function ProjectDetails() {
    ...
    return (
        <>
            <SEO
                title="Creative Web Design Services | Custom Website Design Solutions"
                description="We create creative, responsive, and user-focused web designs that enhance brand identity and deliver exceptional digital experiences."
