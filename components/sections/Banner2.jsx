                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-6 col-lg-7">
                            <div className="banner-content-two">
                                <span className="sub-title">Welcome to Pluginfy</span>
                                <h2 className="title">Pluginfy – Innovative <span>Web & Digital</span> Solutions</h2>
                                <div className="banner-content-bottom">
                                    <Link href="/contact" className="btn1">Contact Us <span /></Link>
